                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="h-100">
                                    <div class="row">
                                        <div class="col-xl-10">
                                            <div class="row">
                                                <div class="col-xl-12 col-md-6" >
                                                    <!-- card -->
											<form method="post" action="insert2.php" id="form1" enctype="multipart/form-data">
											<?php while($row = mysqli_fetch_array($sql11)) { ?>
                                                    <div class="card-animate">
                                                        <div class="div card-animate">
                                                            <div class="d-flex justify-content-between">
                                                                <div class="flex-grow-1">
                                                                    <p><h3>front content</h3></p>
																	<p>main comment</p><input type='text' name="comment" value="<?php echo $row['comment']; ?>">
                                                                    <p>main image</p><input type='file' name="picture2" <?php echo $row['picture2']; ?>>
																	 <br>
																	 <br>
																	 <div>
																	 <table border="1" height="200px" width="300px">
																	 <tr><td> <img src="./img/<?php echo $row['picture2']; ?>" height="200px" width="300px" alt="Image"></td></tr>
																	 </table>
																	 </div>
																	 <br>
																	<br>
										...
										<form method="post" action="insert2.php" id="form2">
											 <div class="col-xl-12 col-md-6">
                                                    <!-- card -->
                                                    <div class="card-animate">
                                                        <div class="div card-animate">
                                                            <div class="d-flex justify-content-between">
																...
																<?php while($row = mysqli_fetch_array($sql12)) { ?>
                                                                    <p><h3>details of employees</h3></p>
                                                                    <textarea id="w3review" name="para" rows="4" cols="50"><?php echo $row['para']; ?>
																	</textarea>
																	<br>
																	<p>rooms</p><input type="text" name="rooms" value="<?php echo $row['rooms']; ?>">
																	<br>
																	<p>staffs</p><input type="text" name="staffs" value="<?php echo $row['staffs']; ?>">
																	<br>
																	<p>clients</p><input type="text" name="clients" value="<?php echo $row['clients']; ?>">
																	<br>
																	<br>
										...
										<form method="post" action="insert2.php" id="form3" enctype="multipart/form-data">
                                                    <div class="card-animate">
                                                        <div class="div card-animate">
                                                            <div class="d-flex justify-content-between">
                                                                <div class="flex-grow-1">
                                                                    <p><h3>side images</h3></p>
																	<p>pic1</p><input type='file' name="pic1">
																	<br>
                                                                    <p>pic2</p><input type='file' name="pic2">
																	<br>
																	 <p>pic3</p><input type='file' name="pic3">
																	<br>
																	<p>pic4</p><input type='file' name="pic4">
																	 <br>
																	  <br>
																	 <br>
																	 <div>
																	 ...
																	 <tr>
																		...
																		<tr>
																		<td><img src="./img/<?php echo $row['pic1']; ?>" height="250px" width="200px" alt="Image"></td>
																		<td><img src="./img/<?php echo $row['pic2']; ?>" height="250px" width="200px" alt="Image"></td>
																		<td><img src="./img/<?php echo $row['pic3']; ?>" height="250px" width="200px" alt="Image"></td>
																		<td><img src="./img/<?php echo $row['pic4']; ?>" height="250px" width="200px" alt="Image"></td>
																		</tr>
																	 </table>
																	 </div>
																	 <br>
										...
										<form method="post" action="insert2.php" id="form4" enctype="multipart/form-data">
                                                    <div class="card-animate">
                                                        <div class="div card-animate">
														 <?php while($row = mysqli_fetch_array($sql14)) { ?>
                                                            <div class="d-flex justify-content-between">
                                                                <div class="flex-grow-1">
                                                                    <p><h3>staff details</h3></p>
																	<p>photo</p><input type='file' name="pic5" >
																	<br>
                                                                    <p>name</p><input type='text' name="name1" value="<?php echo $row['name1']; ?>">
																	<br>
																	 <p>professional</p><input type='text' name="jobrole1" value="<?php echo $row['jobrole1']; ?>">
																	<br>
																	<br>
																	<div>
																	 <table border="1" height="250px" width="200px">
																	<tr>
																		<tr>
																			<th>Photo</th>
																		</tr>
																	</tr>
																	<td><img src="./img/<?php echo $row['pic5']; ?>" height="250px" width="200px" alt="Image"></td>
																	</table>
																	</div>
																	<br>
																	<br>
										...
										<form method="post" action="insert2.php" id="form5" enctype="multipart/form-data">
										 <?php while($row = mysqli_fetch_array($sql15)) { ?>
                                                    <div class="card-animate">
                                                        <div class="div card-animate">
                                                            <div class="d-flex justify-content-between">
                                                                <div class="flex-grow-1">
                                                                    <p><h3>staff details 1</h3></p>
																	<p>photo</p><input type='file' name="pic6">
																	<br>
                                                                    <p>name</p><input type='text' name="name2" value="<?php echo $row['name2']; ?>">
																	<br>
																	 <p>professional</p><input type='text' name="jobrole2" value="<?php echo $row['jobrole2']; ?>">
																	<br>
																	<br>
																	<div>
																	 <table border="1" height="250px" width="200px">
																	...
																	<td><img src="./img/<?php echo $row['pic6']; ?>" height="250px" width="200px" alt="Image"></td>
																	</table>
																	</div>
																	<br>
																	<br>
										...
										<form method="post" action="insert2.php" id="form6" enctype="multipart/form-data">
                                                    <div class="card-animate">
                                                        <div class="div card-animate">
														 <?php while($row = mysqli_fetch_array($sql16)) { ?>
                                                            <div class="d-flex justify-content-between">
                                                                <div class="flex-grow-1">
                                                                    <p><h3>staff details 2</h3></p>
																	<p>photo</p><input type='file' name="pic7">
																	<br>
                                                                    <p>name</p><input type='text' name="name3" value="<?php echo $row['name3']; ?>">
																	<br>
																	 <p>professional</p><input type='text' name="jobrole3" value="<?php echo $row['jobrole3']; ?>">
																	<br>
																	<br>
																	<div>
																	 <table border="1" height="250px" width="200px">
																	...
																	<td><img src="./img/<?php echo $row['pic7']; ?>" height="250px" width="200px" alt="Image"></td>
																	</table>
																	</div>
																	<br>
																	<br>
							...
							<form method="post" action="insert2.php" id="form7" enctype="multipart/form-data">
                                                    <div class="card-animate">
                                                        <div class="div card-animate" >
															 <?php while($row = mysqli_fetch_array($sql17)) { ?>
                                                            <div class="d-flex justify-content-between">
                                                                <div class="flex-grow-1">
                                                                    <p><h3>staff details 3</h3></p>
																	<p>photo</p><input type='file' name="pic8">
																	<br>
                                                                    <p>name</p><input type='text' name="name4" value="<?php echo $row['name4']; ?>">
																	<br>
																	 <p>professional</p><input type='text' name="jobrole4" value="<?php echo $row['jobrole4']; ?>">
																	<br>
																	<br>
																	<div>
																	 <table border="1" height="250px" width="200px">
																	...
																	<td><img src="./img/<?php echo $row['pic8']; ?>" height="250px" width="200px" alt="Image"></td>
																	</table>
																	</div>
																	<br>
																	<br>
