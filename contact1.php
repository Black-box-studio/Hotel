...
include('dbconnection.php');
	...
	$sql1="SELECT * FROM contact_front_image";
                                        ...
                                        <div class="col-xl-10">
                                            <div class="row">
											 ...
											 <div class="col-xl-12 col-md-6">
                                                    <!-- card -->
									 	<form method='post' action="insert6.php" id="form1" enctype="multipart/form-data">		
                                                        ...
                                                        <div class="div card-animate">
                                                            ...
                                                            <div class="d-flex justify-content-between">
                                                                <div class="flex-grow-1">
                                                                    ...
                                                                    <p><h3>contact mails</h3></p>
																	<br>
																	<p>booking</p>
                                                                    <input type="text" name="bookingmail" value="<?php echo $row['bookingmail']; ?>">
																	<br>
																	<p>general</p>
                                                                    <input type="text" name="generalmail" value="<?php echo $row['generalmail']; ?>">
																	<br>
																	<p>technical</p>
                                                                    <input type="text" name="technicalmail" value="<?php echo $row['technicalmail']; ?>">
																	<br>
                                                                    <br>
...
<style>
	body {
	background-image: url('./wallpaper/25.jpg');
