...
$sql="SELECT * FROM  reservation_1" ;
$sqll="SELECT * FROM  payment" ;
$sqlll="SELECT * FROM  back" ;
$results= mysqli_query($conn,$sql);
$results1= mysqli_query($conn,$sqll);
$results12= mysqli_query($conn,$sqlll);
                            ...
                            <div data-simplebar style="max-height: 300px;" class="pe-2 ps-3 my-3">
                                <div class="list-group list-group-flush">
                                    ...
                                    <div class="notification-group-list">
                                        ...
                                        <a href="javascript:void(0);" class="list-group-item dropdown-item notify-item"><i class="bi bi-link-45deg me-2 align-middle"></i> <span>www.contactvengat.com</span></a>
                                    </div>
                                                            ...
                                                            <div class="d-flex justify-content-between">
                                                                <div class="flex-grow-1">
                                                                 <h2>Reservation details</h2>
																	<button class="btn btn-warning"><a href="booking.php">Add New user</a></button>
																	<br>
																	<br>
																	<table border width="800">
																		...
																		<?php while($row = mysqli_fetch_array($results)) { ?>
																			<tr>
																				...
																				<td><button id="button1" class="btn btn-success"><a href="reservedit1.php?id=<?php echo $row['id']; ?>">Edit</a></button></td>
																				<td><button id="button2" class="btn btn-danger"><a href="delete1.php?id=<?php echo $row['id']; ?>&table=reservation_1">Delete</a></button>
																				</td>
																			</tr>
																		<?php } ?>
																	</table>
																	...
																	<table border width="600">
																		...
																		<?php while($row = mysqli_fetch_array($results1)) { ?>
																			<tr>
																				...
																				<td><button id="button1" class="btn btn-success"><a href="payedit2.php?id=<?php echo $row['id']; ?>">Edit</a></button></td>
																				<td><button id="button2" class="btn btn-danger"><a href="delete2.php?id=<?php echo $row['id']; ?>&table=payment">Delete</a></button>
																				</td>
																			</tr>
																		<?php } ?>
																	</table>
                                                                ...
                                                                <div class="flex-grow-1">
                                                                 <h2>Feedback details</h2>
																	...
																	<table border width="600">
																		...
																		<?php while($row = mysqli_fetch_array($results12)) { ?>
																			<tr>
																				<td><?php echo $row['name']; ?></td>
																				<td><?php echo $row['email']; ?></td>
																				<td><?php echo $row['subject']; ?></td>
																				<td><?php echo $row['message']; ?></td>
																				<td><button id="button1" class="btn btn-success"><a href="feededit3.php?id=<?php echo $row['id']; ?>">Edit</a></button></td>
																				<td><button id="button2" class="btn btn-danger"><a href="delete3.php?id=<?php echo $row['id']; ?>&table=back">Delete</a></button>
																				</td>
																			</tr>
																		<?php } ?>
																	</table>
...
<style>		
	body {
	background-image: url('./wallpaper/23.jpg');
