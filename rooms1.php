...
<head>
    ...
    <div class="w-100">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="h-100">
                                        ...
                                        <div class="col-xl-10">
                                            <div class="row">
											 ...
											 <div class="col-xl-12 col-md-6">
                                                    <!-- card -->
											<form method='post' action="insert4.php" id="form1" enctype="multipart/form-data">		
                                                        ...
                                                        <div class="div card-animate">
                                                            <div class="d-flex justify-content-between">
                                                                <div class="flex-grow-1">
                                                                    ...
                                                                    <p><h3> front image</h3></p>
																	<br>
																	<p>comment</p>
                                                                    <input type="text" name="frontcomment" value="<?php echo $row['frontcomment']; ?>">
																	<br>
																	...
																	<input type="file" name="pic1">
																	 ...
																	 <tr><td> <img src="./img/<?php echo $row['pic1']; ?>" height="200px" width="300px" alt="Image"></td></tr>
																	 </table>
																	 </div>
																	 <br>
																	<br>
									...
									<form method='post' action="insert4.php" id="form2" enctype="multipart/form-data">		
                                                        ...
                                                        <div class="div card-animate">
                                                            ...
                                                            <div class="d-flex justify-content-between">
                                                                <div class="flex-grow-1">
																	...
																	<br>
																	<p>room name</p>
																	<input type="text" name="roomname" value="<?php echo $row['roomname']; ?>">
																	<br>
																	<p>bed</p>
																	<input type="text" name="bed" value="<?php echo $row['bed']; ?>">
																	<br>
																	<p>bath</p>
																	<input type="text" name="bath" value="<?php echo $row['bath']; ?>">
																	<br>
																	<p>wifi</p>
																	<input type="text" name="wifi" value="<?php echo $row['wifi']; ?>">
																	<br>
																	<p>feature</p>
																	<textarea  name="feature" rows="4" cols="50"><?php echo $row['feature']; ?>
																	</textarea>	
																	<br>																 
																	 <br>
																	 <div>
																	 <table border="1" height="200px" width="300px">
																	 <tr><td> <img src="./img/<?php echo $row['pic2']; ?>" height="200px" width="300px" alt="Image"></td></tr>
																	 </table>
																	 </div>
																	 <br>
																	<br>
		...
		<form method='post' action="insert4.php" id="form3" enctype="multipart/form-data">	
                                                        ...
                                                        <div class="div card-animate">
                                                            <div class="d-flex justify-content-between">
                                                                <div class="flex-grow-1">
                                                                    ...
                                                                    <p><h3>double room</h3></p>
																	<br>
																	<p>rooms image</p>
                                                                    <input type="file" name="pic3">
																	<br>
																	<p>rate</p>
                                                                    <input type="text" name="rate1" value="<?php echo $row['rate1']; ?>">
																	<br>
																	<p>room name</p>
																	<input type="text" name="roomname1" value="<?php echo $row['roomname1']; ?>">
																	<br>
																	<p>bed</p>
																	<input type="text" name="bed1" value="<?php echo $row['bed1']; ?>">
																	<br>
																	<p>bath</p>
																	<input type="text" name="bath1" value="<?php echo $row['bath1']; ?>">
																	<br>
																	<p>wifi</p>
																	<input type="text" name="wifi1" value="<?php echo $row['wifi1']; ?>">
																	<br>
																	<p>feature</p>
																	<textarea  name="feature1" rows="4" cols="50"><?php echo $row['feature1']; ?>
																	</textarea>	
																	<br>																 
																	 <br>
																	 <div>
																	 <table border="1" height="200px" width="300px">
																	 <tr><td> <img src="./img/<?php echo $row['pic3']; ?>" height="200px" width="300px" alt="Image"></td></tr>
																	 </table>
																	 </div>
																	 <br>
																	<br>
																	<input type="submit" class="btn btn-primary" name="submit3">
                                                                </div>
	...
	<form method='post' action="insert4.php" id="form4" enctype="multipart/form-data">
                                                        ...
                                                        <div class="div card-animate">
                                                            <div class="d-flex justify-content-between">
                                                                <div class="flex-grow-1">
                                                                    ...
                                                                    <p><h3>triple room</h3></p>
																	<br>
																	<p>rooms image</p>
                                                                    <input type="file" name="pic4">
																	<br>
																	<p>rate</p>
                                                                    <input type="text" name="rate2" value="<?php echo $row['rate2']; ?>">
																	<br>
																	<p>room name</p>
																	<input type="text" name="roomname2" value="<?php echo $row['roomname2']; ?>">
																	<br>
																	<p>bed</p>
																	<input type="text" name="bed2" value="<?php echo $row['bed2']; ?>">
																	<br>
																	<p>bath</p>
																	<input type="text" name="bath2" value="<?php echo $row['bath2']; ?>">
																	<br>
																	<p>wifi</p>
																	<input type="text" name="wifi2" value="<?php echo $row['wifi2']; ?>">
																	<br>
																	<p>feature</p>
																	<textarea  name="feature2" rows="4" cols="50"><?php echo $row['feature2']; ?>
																	</textarea>	
																	<br>																 
																	 <br>
																	 <div>
																	 <table border="1" height="200px" width="300px">
																	 <tr><td> <img src="./img/<?php echo $row['pic4']; ?>" height="200px" width="300px" alt="Image"></td></tr>
																	 </table>
																	 </div>
																	 <br>
																	<br>
...
<form method='post' action="insert4.php" id="form5" enctype="multipart/form-data">		
                                                    <div class="card-animate">
                                                        ...
                                                        <div class="div card-animate">
                                                            <div class="d-flex justify-content-between">
                                                                <div class="flex-grow-1">
                                                                    ...
                                                                    <p><h3>Executive suite</h3></p>
																	<br>
																	<p>rooms image</p>
                                                                    <input type="file" name="pic6">
																	<br>
																	<p>rate</p>
                                                                    <input type="text" name="rate3" value="<?php echo $row['rate3']; ?>">
																	<br>
																	<p>room name</p>
																	<input type="text" name="roomname3" value="<?php echo $row['roomname3']; ?>">
																	<br>
																	<p>bed</p>
																	<input type="text" name="bed3" value="<?php echo $row['bed3']; ?>">
																	<br>
																	<p>bath</p>
																	<input type="text" name="bath3" value="<?php echo $row['bath3']; ?>">
																	<br>
																	<p>wifi</p>
																	<input type="text" name="wifi3" value="<?php echo $row['wifi3']; ?>">
																	<br>
																	<p>feature</p>
																	<textarea  name="feature3" rows="4" cols="50"><?php echo $row['feature3']; ?>
																	</textarea>	
																	<br>																 
																	 <br>
																	 <div>
																	 <table border="1" height="200px" width="300px">
																	 <tr><td> <img src="./img/<?php echo $row['pic6']; ?>" height="200px" width="300px" alt="Image"></td></tr>
																	 </table>
																	 </div>
																	 <br>
																	<br>
		...
		<form method='post' action="insert4.php" id="form6" enctype="multipart/form-data">		
                                                    <div class="card-animate">
                                                        <div class="div card-animate">
														<?php while($row = mysqli_fetch_array($sql16)) { ?>
                                                            <div class="d-flex justify-content-between">
                                                                <div class="flex-grow-1">
                                                                    ...
                                                                    <p><h3>Junior suite</h3></p>
																	<br>
																	<p>rooms image</p>
                                                                    <input type="file" name="pic7">
																	<br>
																	<p>rate</p>
                                                                    <input type="text" name="rate4" value="<?php echo $row['rate4']; ?>">
																	<br>
																	<p>room name</p>
																	<input type="text" name="roomname4" value="<?php echo $row['roomname4']; ?>">
																	<br>
																	<p>bed</p>
																	<input type="text" name="bed4" value="<?php echo $row['bed4']; ?>">
																	<br>
																	<p>bath</p>
																	<input type="text" name="bath4" value="<?php echo $row['bath4']; ?>">
																	<br>
																	<p>wifi</p>
																	<input type="text" name="wifi4" value="<?php echo $row['wifi4']; ?>">
																	<br>
																	<p>feature</p>
																	<textarea  name="feature4" rows="4" cols="50"><?php echo $row['feature4']; ?>
																	</textarea>	
																	<br>																 
																	 <br>
																	 <div>
																	 <table border="1" height="200px" width="300px">
																	 <tr><td> <img src="./img/<?php echo $row['pic7']; ?>" height="200px" width="300px" alt="Image"></td></tr>
																	 </table>
																	 </div>
																	 <br>
																	<br>
																	<input type="submit" class="btn btn-primary" name="submit6">
                                                                </div>
	...
	<form method='post' action="insert4.php" id="form7" enctype="multipart/form-data">		
                                                    <div class="card-animate">
                                                        ...
                                                        <div class="div card-animate">
                                                            <div class="d-flex justify-content-between">
                                                                <div class="flex-grow-1">
                                                                    ...
                                                                    <p><h3>deluxe suite</h3></p>
																	<br>
																	<p>rooms image</p>
                                                                    <input type="file" name="pic8">
																	<br>
																	<p>rate</p>
                                                                    <input type="text" name="rate5"  value="<?php echo $row['rate5']; ?>">
																	<br>
																	<p>room name</p>
																	<input type="text" name="roomname5"  value="<?php echo $row['roomname5']; ?>">
																	<br>
																	<p>bed</p>
																	<input type="text" name="bed5"  value="<?php echo $row['bed5']; ?>">
																	<br>
																	<p>bath</p>
																	<input type="text" name="bath5"  value="<?php echo $row['bath5']; ?>">
																	<br>
																	<p>wifi</p>
																	<input type="text" name="wifi5"  value="<?php echo $row['wifi5']; ?>">
																	<br>
																	<p>feature</p>
																	<textarea  name="feature5" rows="4" cols="50"><?php echo $row['feature5']; ?>
																	</textarea>	
																	<br>																 
																	 <br>
																	 <div>
																	 <table border="1" height="200px" width="300px">
																	 <tr><td> <img src="./img/<?php echo $row['pic8']; ?>" height="200px" width="300px" alt="Image"></td></tr>
																	 </table>
																	 </div>
																	 <br>
																	<br>
																	<input type="submit" class="btn btn-primary" name="submit7">
                                                                </div>
...
<style>
	body {
	background-image: url('./wallpaper/14.jpg');
