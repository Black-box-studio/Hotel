...
<head>
    ...
    <div class="w-100">
        <div class="row justify-content-between align-items-center">
            ...
            <!-- ============================================================== -->
        <form method='post' action="insert3.php" id="form1" enctype="multipart/form-data">
	...
	<form method="post" action="insert3.php" id="form2">											
											 <div class="col-xl-12 col-md-6">
                                                    <!-- card -->
                                                    <div class="card-animate">
	...
	<form method="post" action="insert3.php" id="form3" >											
											 <div class="col-xl-12 col-md-6">
                                                    <!-- card -->
                                                    <div class="card-animate">
                                                        <div class="div card-animate">
														<?php while($row = mysqli_fetch_array($sql13)) { ?>
                                                            <div class="d-flex justify-content-between">
                                                                <div class="flex-grow-1">
                                                                    <p><h3>service room</h3></p>
                                                                  
                                                                    <p>topic</p><input type="text" name="para1" value="<?php echo $row['para1']; ?>"><br>
																	<br>
                                                                    <p>service</p> <textarea name="para2" rows="4"  cols="50"><?php echo $row['para2']; ?>
																	</textarea>
                                                                     <br>
																	 <br>
											 ...
											 <div class="col-xl-12 col-md-6">
                                                    ...
                                                    <div class="card-animate">
														...
														<?php while($row = mysqli_fetch_array($sql14)) { ?>
                                                            <div class="d-flex justify-content-between">
                                                                <div class="flex-grow-1">
                                                                    <p><h3>service food</h3></p>
                                                                  
                                                                    <p>topic</p><input type="text" name="para3" value="<?php echo $row['para3']; ?>"><br>
																	<br>
                                                                    <p>service</p> <textarea name="para4" rows="4"  cols="50"><?php echo $row['para4']; ?>
																	</textarea>
                                                                     <br>
																	 <br>
                                                                     <input type="submit" class="btn btn-primary" id="3" name="submit4">
                                                                </div>
	...
	<form method="post" action="insert3.php" id="form5" >											
											 <div class="col-xl-12 col-md-6">
                                                    <!-- card -->
                                                    <div class="card-animate">
                                                        <div class="div card-animate">
                                                            ...
                                                            <div class="d-flex justify-content-between">
                                                                <div class="flex-grow-1">
                                                                    <p><h3>service fitness</h3></p>
                                                                  
                                                                    <p>topic</p><input type="text" name="para5" value="<?php echo $row['para5']; ?>"><br>
																	<br>
                                                                    <p>service</p> <textarea name="para6" rows="4"  cols="50"><?php echo $row['para6']; ?>
																	</textarea>
                                                                     <br>
																	 <br>
                                                                     <input type="submit" class="btn btn-primary" id="3" name="submit5">
                                                                </div>
	...
	<form method="post" action="insert3.php" id="form6" >											
											 <div class="col-xl-12 col-md-6">
                                                    <!-- card -->
                                                    <div class="card-animate">
                                                        <div class="div card-animate">
                                                            ...
                                                            <div class="d-flex justify-content-between">
                                                                <div class="flex-grow-1">
                                                                    <p><h3>service sports</h3></p>
                                                                  
                                                                    <p>topic</p><input type="text" name="para7" value="<?php echo $row['para7']; ?>"><br>
																	<br>
                                                                    <p>service</p> <textarea name="para8" rows="4"  cols="50"><?php echo $row['para8']; ?>
																	</textarea>
                                                                     <br>
																	 <br>
                                                                     <input type="submit" class="btn btn-primary" id="3" name="submit6">
                                                                </div>
	...
	<form method="post" action="insert3.php" id="form7" >											
											 <div class="col-xl-12 col-md-6">
                                                    <!-- card -->
                                                    <div class="card-animate">
                                                        <div class="div card-animate">
                                                            ...
                                                            <div class="d-flex justify-content-between">
                                                                <div class="flex-grow-1">
                                                                    <p><h3>service event</h3></p>
                                                                  
                                                                    <p>topic</p><input type="text" name="para9" value="<?php echo $row['para9']; ?>"><br>
																	<br>
                                                                    <p>service</p> <textarea name="para10" rows="4"  cols="50"><?php echo $row['para10']; ?>
																	</textarea>
                                                                     <br>
																	 <br>
                                                                     <input type="submit" class="btn btn-primary" id="3" name="submit7">
                                                                </div>
	...
	<form method="post" action="insert3.php" id="form8" >											
											 <div class="col-xl-12 col-md-6">
                                                    <!-- card -->
                                                    <div class="card-animate">
                                                        <div class="div card-animate">
                                                            ...
                                                            <div class="d-flex justify-content-between">
                                                                <div class="flex-grow-1">
                                                                    <p><h3>service yoga</h3></p>
                                                                  
                                                                    <p>topic</p><input type="text" name="para11"  value="<?php echo $row['para11']; ?>"><br>
																	<br>
                                                                    <p>service</p> <textarea name="para12" rows="4"  cols="50"><?php echo $row['para12']; ?>
																	</textarea>
                                                                     <br>
																	 <br>
                                                                     <input type="submit" class="btn btn-primary" id="3" name="submit8">
                                                                </div>
...
<style>
	body {
	background-image: url('./wallpaper/20.jpg');
