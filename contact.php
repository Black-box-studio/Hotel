                ...
                <div class="row g-4">
                    <div class="col-12">
                        ...
                        <div class="row gy-4">
                            <div class="col-md-4">
                                ...
                                <p><i class="fa fa-envelope-open text-primary me-2"></i><?php echo $row['bookingmail']; ?></p>
                            </div>
                            <div class="col-md-4">
                                <h6 class="section-title text-start text-primary text-uppercase">General</h6>
                                <p><i class="fa fa-envelope-open text-primary me-2"></i><?php echo $row['generalmail']; ?></p>
                            </div>
                            <div class="col-md-4">
                                <h6 class="section-title text-start text-primary text-uppercase">Technical</h6>
                                <p><i class="fa fa-envelope-open text-primary me-2"></i><?php echo $row['technicalmail']; ?></p>
                            </div>
                        </div>
					<?php } ?>		
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="wow fadeInUp" data-wow-delay="0.2s">
                            <form id="contactForm" onsubmit="validateForm()" method="post" action="insert9.php">
                                <div class="row g-3">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-12">
                                        <input type="submit" class="btn btn-primary w-100 py-3" value="submit" name="submit1" id='submit'>
                                    </div>
