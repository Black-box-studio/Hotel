                                        ...
                                        <div class="col-xl-12">
                                            <div class="row">
											 ...
											 <div class="col-xl-12 col-md-10">
													...
													<h2 class="h">Payment Re-correction</h2> <br>
													<label>Card number</label>
													<input type="text" name="card" id="card" value="<?php echo $row['card']; ?>"> <br><br>
														<label>Expiry date</label>
													<input type="text" name="expiry" id="expiry" value="<?php echo $row['expiry']; ?>"><br><br>
													<label>Cvv number</label>
													<input type="text" name="ccv" id="ccv" value="<?php echo $row['ccv']; ?>"><br><br>
													<br><br>
...
.h{
	...
	body {
	background-image: url('./wallpaper/29.jpg');
