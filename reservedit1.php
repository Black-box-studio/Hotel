...
include('dbconnection.php');
    ...
    $id=$_GET['id'];
    $sql="SELECT * FROM reservation_1 WHERE id='$id'";
											 ...
											 <div class="col-xl-12 col-md-10">
                                                    ...
                                                    <div class="card-animate">
                                                      ...
                                                      <form method="post" action="insert8.php">
														...
														<h2 class="h">Rservation Re-correption</h2>
														 ...
														 <input type="text" id="Name" name="name" value="<?php echo $row['name']; ?>"><br><br>
														  ...
														  <input type="text" id="adults" name="adults" value="<?php echo $row['adults'];?>"><br><br>

														  <label>Children</label>

														  <input type="text" id="Children" name="Children" value="<?php echo $row['Children'];?>"><br><br>

														  <label>checkindate</label>

														  <input type="text" id="checkinDate" name="checkinDate" value="<?php echo $row['checkinDate'];?>"><br><br>
														  
														   <label>checkoutdate</label>
														   
														  <input type="text" id="checkOutDate" name="checkOutDate" value="<?php echo $row['checkOutDate'];?>"><br><br>
														  
														   <label>message</label>
														   
														  <input type="text" id="message" name="message" value="<?php echo $row['message'];?>"><br><br>
...
.h{
	...
	body {
	background-image: url('./wallpaper/30.jpg');
