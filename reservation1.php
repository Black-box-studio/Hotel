                                        ...
                                        <div class="col-xl-10">
                                            <div class="row">
                                                <div class="col-xl-12 col-md-6">
                                                    <!-- card -->
                                                   	<form method='post' action="insert5.php" id="form1" enctype="multipart/form-data">		
													...
													<?php } ?>	
                                                        ...
                                                        <div class="animation-effect-3 text-success opacity-25 fs-18">
															...
															<form method="post" action="insert5.php" id="form3" enctype="multipart/form-data">
                                                    <div class="card-animate">
                                                        <div class="div card-animate">
                                                            <div class="d-flex justify-content-between">
                                                                <div class="flex-grow-1">
...
<style>
	body {
	background-image: url('./wallpaper/28.jpg');
